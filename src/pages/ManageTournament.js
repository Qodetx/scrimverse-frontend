            ...
            <div className="info-grid-card rounded-[2.5rem] p-6 border border-white/10 mb-8 animate-in zoom-in-95 duration-500">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-[9px] text-gray-500 font-black uppercase tracking-[0.2em] mb-2 ml-1 flex items-center gap-2">
                      <svg
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <input
                            ...
                            disabled={tournament.status !== 'upcoming'}
                            className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-sm font-bold focus:outline-none focus:border-accent-purple/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                          />
                        </div>
                        <div>
                          <label className="block text-[9px] text-gray-500 font-black uppercase tracking-[0.15em] mb-1">
